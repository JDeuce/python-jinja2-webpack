...
When `reporting a bug <https://github.com/JDeuce/python-jinja2-webpack/issues>`_ please include:
...
1. Fork `python-jinja2-webpack <https://github.com/JDeuce/python-jinja2-webpack>`_
...
.. [1] If you don't have all the necessary python versions available locally you can rely on Travis - it will
       `run the tests <https://travis-ci.org/JDeuce/python-jinja2-webpack/pull_requests>`_ for each change you add in the pull request.
